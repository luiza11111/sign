...
const translations = {
  kk: {
    ...
    'dactyl_mode_description': 'Әр әріптің нақты дактиль ымын көрсететін қол пішіндері.',
  ...
  ru: {
    ...
    'dactyl_mode_description': 'Показывает точные жесты дактиля для каждой буквы.',
  ...
  en: {
    ...
    'dactyl_mode_description': 'Displays precise dactyl handshapes for each letter.',
