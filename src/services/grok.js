...
const SYSTEM_PROMPT = `Сен SignFlow AI көмекшісісің. SignFlow - қазақ ым тіліне аударатын веб-қосымша.
...
function getOfflineResponse(message) {
  ...
  if (q.includes('сәлем') || q.includes('салем') || q.includes('hello')) {
    return 'Сәлем! Мен Grok AI көмекшісімін. Қазақ ым тіліне аударма жасауға көмектесемін! 🤟'
  }
  ...
  return 'Мен Grok AI көмекшісімін. Кез келген сұрағыңызды қоюға болады! Қазақ ым тілі, аударма, немесе кез келген тақырып бойынша сұраңыз. 🤖'
}
